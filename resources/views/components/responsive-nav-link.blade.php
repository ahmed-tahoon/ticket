...
@php
    $classes = ($active ?? false)
                ? 'block pl-3 pr-4 py-2 border-l-4 border-black-400 text-base font-medium text-black-700 bg-blue-50 focus:outline-none focus:text-black-800 focus:bg-black-100 focus:border-black-700 transition duration-150 ease-in-out'
