    ...
    <div class="sm:hidden">
        ...
        >
            <x-slot:trigger>
                <button
                    type="button"
                    class="relative w-full cursor-default rounded-md border border-slate-300 bg-white py-2 pl-3 pr-10 text-left shadow-sm focus:border-black-500 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-black-500 sm:text-sm dark:border-slate-600 dark:bg-slate-700 dark:text-slate-200 dark:focus:ring-offset-slate-800"
                >
        ...
        <div class="border-b border-slate-200 dark:border-slate-600">
            ...
            >
                <a
                    ...
                    @class(['whitespace-nowrap py-4 px-1 border-b-2 font-medium text-sm', 'border-black-500 text-black-600 dark:border-slate-200 dark:text-slate-200' => request()->routeIs('agent.settings.general'), 'border-transparent text-slate-500 hover:text-slate-700 hover:border-slate-300 dark:text-slate-400 dark:hover:text-slate-300 dark:hover:border-slate-300' => !request()->routeIs('agent.settings.general')])
                >
                    {{ __('General') }}
                </a>
                <a
