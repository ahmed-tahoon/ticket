                ...
                <div class="lg:col-span-9 min-h-[500px]">
                    <div class="border-b border-slate-200 pl-4 pr-6 pt-4 pb-4 sm:pl-6 lg:pl-8 xl:pl-6 xl:pt-6">
                        ...
                        <div>
                            ...
                            >
                                {{ __('Submitted :timeago', ['timeago' => $ticket->created_at->diffForHumans()]) }}
                                {{ __('on') }}
                                <time datetime="{{ $ticket->created_at->toIso8601ZuluString() }}">{{ $ticket->created_at->toFormattedDateString() }}</time>
                            </p>
                        </div>
                    </div>
