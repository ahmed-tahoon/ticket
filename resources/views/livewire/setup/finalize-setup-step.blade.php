                ...
                <div class="flex items-center justify-center">
                    <div class="text-center">
                        ...
                        <a
                            ...
                            class="mt-5 inline-flex items-center justify-center px-4 py-2 border border-transparent text-sm font-medium rounded-md text-white bg-black-600 hover:bg-black-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-black-500"
                        >
                            {{ __('Go to Dashboard') }}
                        </a>
                    </div>
