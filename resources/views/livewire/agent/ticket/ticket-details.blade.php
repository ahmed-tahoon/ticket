<div>
    <div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 xl:max-w-7xl xl:grid xl:grid-cols-3">
        ...
        <aside class="hidden xl:block xl:pl-8">
            ...
            <!-- Assignees & Labels -->
            <div class="mt-6 border-t border-slate-200 py-6 space-y-6 dark:border-slate-600">
                <!-- Product -->
                <div>
                    <div class="flex items-center justify-between">
                        <h2 class="text-sm font-medium text-slate-500 dark:text-slate-400">
            ...
            <div class="border-t border-slate-200 py-6 space-y-6 dark:border-slate-600">
                @foreach($ticket->customFieldResponses as $customFieldResponse)
                    <div>
                        <div class="flex items-center justify-between">
                            <h2 class="text-sm font-medium text-slate-500 dark:text-slate-400">
                                {{ $customFieldResponse->customField->title }}
                            </h2>
                        </div>
                        <div class="mt-2 flex items-start">
                            <div class="text-sm font-medium text-slate-900 dark:text-slate-200">
                                {{ $customFieldResponse->value }}
                            </div>
                        </div>
                    </div>
                @endforeach
