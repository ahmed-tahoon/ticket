                                        ...
                                        @forelse($tickets as $ticket)
                                            ...
                                            >
                                                <td class="pl-4 pr-3 py-4 font-medium text-sm text-slate-900 whitespace-nowrap sm:pl-6 dark:text-slate-200">
                                                    <div class="flex">
                                                        <div
                                                            ...
                                                            class="mr-2 flex-shrink-0 self-center"
                                                        >
                                                            @if($ticket->product->hasMedia('logo'))
                                                                <img
                                                                    src="{{ $ticket->product->getFirstMediaUrl('logo') }}"
                                                                    alt="{{ $ticket->product->name }}"
                                                                    class="h-10 w-10 rounded-full object-cover object-center"
                                                                >
                                                            @else
                                                                <x-heroicon-o-cube class="h-10 w-10 bg-slate-100 text-slate-500 rounded-full p-1 dark:bg-slate-700 dark:text-slate-400" />
                                                            @endif
                                                        </div>
                                                        <div>
                                                            <a
                                                            ...
                                                            <p class="ml-4 font-normal text-slate-500 dark:text-slate-400">
                                                                ...
                                                                {{ __('opened') }}
                                                                <time
                                                                    datetime="{{ $ticket->created_at->toIso8601ZuluString() }}"
                                                                    title="{{ $ticket->created_at }} {{ config('app.timezone') }}"
                                                                >
                                                ...
                                                <td class="pl-3 pr-4 py-4 text-right text-sm text-slate-500 whitespace-nowrap sm:pr-6 dark:text-slate-400">
                                                    <time
                                                        datetime="{{ $ticket->updated_at->toIso8601ZuluString() }}"
                                                        title="{{ $ticket->updated_at }} {{ config('app.timezone') }}"
                                                    >
